...
best_mdepth = range(1,6)[np.argmax(average)]

final_model =  RandomForestClassifier(n_estimators = 100, criterion = "gini", max_features = "sqrt", max_depth = mdepth, n_jobs = 4, verbose = 0)
